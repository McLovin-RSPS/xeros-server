...
public class ChargeTrident {
	...
	public void TumekensShadow(String amount) {

		if (!player.getItems().playerHasItem(27275, 1)) {
			return;
		}
		if (player.getTumekensShadowCharge() >= 2500) {
			player.sendMessage("Your trident already has 2,500 charge.");
			return;
		}
		...
		switch (amount) {
			case "TEN": // Plus 10
				...
				player.getItems().deleteItem2(562, 10);
				player.getItems().deleteItem2(12934, 10);
				player.setTumekensShadowCharge(player.getTumekensShadowCharge() >= 2490 ? 2500 : player.getTumekensShadowCharge() + 10);
				player.sendMessage("You successfully added 10 toxic charges to your trident.");
				break;
			...
			case "HUNDRED": // Plus 100
				...
				player.getItems().deleteItem2(562, 100);
				player.getItems().deleteItem2(12934, 100);
				player.setTumekensShadowCharge(player.getTumekensShadowCharge() >= 2400 ? 2500 : player.getTumekensShadowCharge() + 100);
				player.sendMessage("You successfully added 100 charges to your trident.");
				break;
			...
			case "THOUSAND": // Plus 1000
				...
				player.getItems().deleteItem2(562, 1000);
				player.getItems().deleteItem2(12934, 1000);
				player.setTumekensShadowCharge(player.getTumekensShadowCharge() >= 1500 ? 2500 : player.getTumekensShadowCharge() + 1000);
				player.sendMessage("You successfully added 1000 charges to your trident.");
				break;
		}
	}

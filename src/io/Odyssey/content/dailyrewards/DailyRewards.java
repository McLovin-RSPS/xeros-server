package io.Odyssey.content.dailyrewards;
...
import io.Odyssey.util.logging.global.DailyRewardsCompletedLog;
import io.Odyssey.util.logging.player.DailyRewardLog;

public class DailyRewards {

    public static final int CLAIM_BUTTON = 23_721;
    public static final String COLOR = "<col=bl3>";
    ...
    public void openInterface() {
        ...
        for (int interfaceId = ITEM_BOXES_START_INTERFACE_ID; interfaceId <= ITEM_BOXES_END_INTERFACE_ID; interfaceId++) {
            ...
            player.getPA().sendInterfaceHidden(index >= rewards.size() ? 1 : 0, interfaceId);
        }

...
public class WeaponDataConstants {
    ...
    public static final int[] CRUSH_SWORDS = {
        ...
        Items.DRAGON_2H_SWORD, Items.ANCIENT_GODSWORD, Items.ARMADYL_GODSWORD, Items.SARADOMIN_GODSWORD, Items.ZAMORAK_GODSWORD, Items.BANDOS_GODSWORD,
        Items.ARMADYL_GODSWORD_OR, Items.SARADOMIN_GODSWORD_OR, Items.ZAMORAK_GODSWORD_OR, Items.BANDOS_GODSWORD_OR,
        Items.SARADOMIN_SWORD,Items.AOD_GOD_SWORD,Items.SARADOMINS_BLESSED_SWORD, Items.SHADOW_SWORD, Items.SPATULA, Items.GILDED_2H_SWORD,
    };
    ...
    public static final int[] SCYTHE = {
            Items.SCYTHE, Items.SCYTHE_OF_VITUR, Items.HOLY_SCYTHE_OF_VITUR, Items.SANGUINE_SCYTHE_OF_VITUR,
    };
    ...
    public static final int[] STAB_SWORDS = {
        ...
        Items.WILDERNESS_SWORD_1, Items.WILDERNESS_SWORD_2, Items.WILDERNESS_SWORD_3, Items.WILDERNESS_SWORD_4, Items.OSMUMTENS_FANG, Items.OSMUMTENS_FANG_OR,
    };
    ...
    public static final int[] MACES = {
        ...
        Items.VERACS_FLAIL, Items.BARRELCHEST_ANCHOR, Items.SARACHNIS_CUDGEL, Items.VIGGORAS_CHAINMACE, Items.URASINE_CHAINMACE ,Items.INQUISITORS_MACE,
   ...
   public static final int[] STANDARD_STAFFS = {
           ...
           Items.IBANS_STAFF, Items.CRYSTAL_STAFF_PERFECTED,Items.IBANS_STAFF_U, Items.ZURIELS_STAFF,Items.BULLSHIT_STAFF, Items.ACCURSED_SCEPTRE,
   };

    // [[accurate, stab], [aggressive, slash], [defensive, crush]]
    public static final int[] SOTD = {
            Items.STAFF_OF_THE_DEAD,
            Items.TOXIC_STAFF_OF_THE_DEAD, Items.CRYSTAL_STAFF_PERFECTED, Items.TOXIC_STAFF_UNCHARGED
    };
    ...
    public static final int[] BOWS = {
            ...
            Items.DARK_BOW_BLUE, Items.WEBWEAVER_BOW ,Items.DARK_BOW_GREEN,Items.DARK_BOW_YELLOW,Items.DARK_BOW_WHITE, Items.THIRD_AGE_BOW,Items.HAND_CANNON,

            // Crystal bows
            20201,8818,  412, 4213, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223,

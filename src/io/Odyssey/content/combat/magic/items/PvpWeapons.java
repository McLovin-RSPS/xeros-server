...
public class PvpWeapons {
    ...
    private static final int[] PVP_WEAPONS = {
            Items.CRAWS_BOW, Items.THAMMARONS_SCEPTRE, Items.VIGGORAS_CHAINMACE, Items.WEBWEAVER_BOW, Items.URASINE_CHAINMACE,
    };
    ...
    private static final int[] U_PVP_WEAPONS = {Items.CRAWS_BOW_U, Items.THAMMARONS_SCEPTRE_U,
            Items.VIGGORAS_CHAINMACE_U, Items.WEBWEAVER_BOW_U, Items.URASINE_CHAINMACE_U,};
    ...
    private int ursineChainmaceCharges;
    /**
    ...
    private int webweaverBowCharges;
    ...
    public PvpWeapons(Player player) {
        ...
        this.webweaverBowCharges = 40_000;
        this.ursineChainmaceCharges = 40_000;
    }
    ...
    public int getCharges(int weaponId) {
        switch (weaponId) {
            ...
            case Items.URASINE_CHAINMACE:
                return this.ursineChainmaceCharges;
            case Items.WEBWEAVER_BOW:
                return this.webweaverBowCharges;
    ...
    public int getUrsineChainmaceCharges() {
        return ursineChainmaceCharges;
    }

    public void setUrsineChainmaceCharges(int ursineChainmaceCharges) {
        this.ursineChainmaceCharges = ursineChainmaceCharges;
    }
    ...
    public int getWebweaverBowCharges() {
        return webweaverBowCharges;
    }

    public void setWebweaverBowCharges(int webweaverBowCharges) {
        this.webweaverBowCharges = webweaverBowCharges;
    }
    ...
    public static void giveStartingCharges(Player player) {
        ...
        player.getPvpWeapons().setWebweaverBowCharges(40_000);
        player.getPvpWeapons().setUrsineChainmaceCharges(40_000);
    }
    ...
    public static void manipulateCharges(Player player, int weaponId, int amount) {
        ...
        switch (weaponId) {
            ...
            case Items.VIGGORAS_CHAINMACE:
                ...
                break;
            case Items.WEBWEAVER_BOW:
                player.getPvpWeapons().setWebweaverBowCharges(charges + amount);
                break;
            case Items.URASINE_CHAINMACE:
                player.getPvpWeapons().setUrsineChainmaceCharges(charges + amount);
                break;
        }
    }
...
//    public static boolean extrapvpdamage(Player player, int weaponId) {
//        return player.getItems().isWearingItem(weaponId, Player.playerWeapon)
//                && player.getPvpWeapons().getCharges(weaponId) > 0;
//    }
    /**

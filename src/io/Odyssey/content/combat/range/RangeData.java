package io.Odyssey.content.combat.range;

import java.util.*;

import io.Odyssey.content.achievement_diary.DifficultyAchievementDiary;
import io.Odyssey.content.combat.effects.damageeffect.DamageBoostingEffect;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.DiamondBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.DragonBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.EmeraldBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.JadeBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.OnyxBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.OpalBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.PearlBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.RubyBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.SapphireBoltSpecial;
import io.Odyssey.content.combat.effects.damageeffect.impl.bolts.TopazBoltSpecial;
...
public class RangeData {
	...
	public static final int[] BOWS = {19481, 19478, 12788, 9185, 11785, 21012, 839, 845, 847, 851, 855, 859, 841, 843, 849,
			...
			4221, 4222, 4223, 4734, 6724, 20997, 21902, 26374, 8818, 20201, 22550, 27655, 25867, 25884, 25886, 25888, 25890, 25892, 29988, 29985,30051};
	...
	public static final int[] ARROWS = {9341, 4160, 11959, 10033, 10034, 882, 883, 884, 885, 886, 887, 888, 889, 890, 891,
			...
			21958, 21959, 21960, 21961, 21962, 21963, 21964, 21965, 21966, 21967, 21968, 21969, 21970, 21971, 21972,30125, 21973,
			21974}; //25867, 25884, 25886, 25888, 25890, 25892
	...
	public static final int[] NO_ARROW_DROP = {11959, 10033, 10034, 4212, 22550, 27655, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221,
			4222, 4223, 4734, 4934, 4935, 4936, 4937,27655, 22550,};

	public static final int[] DOUBLE_SHOT_BOWS = {11235, 12765, 12766, 12767, 12768, 30051, 27655,};
...
//				
				...
				// CRYSTAL_BOW
				{4212, 250}, {20201, 1925}, {4214, 250}, {27655, 2354}, {22550, 250}, {4215, 250}, {4216, 250}, {4217, 250}, {4218, 250}, {4219, 250}, {4220, 250}, {4221, 250}, {4222, 250},
				{4223, 250}, {25867, 1923}, {29988, 2206},{30051, 2030}, {29985, 2206},  {25884, 1925}, {25886, 1927}, {25888, 1929}, {25890, 1931}, {25892, 1933},
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		// Crossbows
		if (c.playerEquipment[Player.playerWeapon] == 9185 || c.playerEquipment[Player.playerWeapon] == 26374 || c.playerEquipment[Player.playerWeapon] == 11785 || c.playerEquipment[Player.playerWeapon] == 21012
		...
		int[][] data = {
				...
				// OTHERS
				{6522, 442}, {4740, 27}, {4212, 249}, {4214, 249}, {27655, 2354}, {22550, 249}, {4215, 249}, {4216, 249}, {4217, 249}, {4218, 249}, {4219, 249}, {4220, 249}, {4221, 249},
				{4222, 249}, {4223, 249}, {29988, 2206},{ 30051, 2030}, {29985, 2206}, {25884, 1925}, {25886, 1927}, {25888, 1929}, {25890, 1931}, {25892, 1933}, {20201, 1925},};
		for (int l = 0; l < data.length; l++) {
	...
	public static void createCombatGraphic(Entity entity, int graphic, boolean height100) {
		if (entity instanceof Player) {
			...
			if (height100 == true) {
				target.gfx100(graphic); // <<< blow pipe uses this gfx100 shit
			} else {
				target.gfx0(graphic);
			}
		}
	...
	public static boolean wearingCrossbow(Player player) {
		return player.playerEquipment[Player.playerWeapon] == 11785 || player.playerEquipment[Player.playerWeapon] == 9185
				|| player.playerEquipment[Player.playerWeapon] == 21012 || player.playerEquipment[Player.playerWeapon] == 26374 || player.playerEquipment[Player.playerWeapon] == 21902;
	}

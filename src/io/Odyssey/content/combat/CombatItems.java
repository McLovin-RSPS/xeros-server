...
public class CombatItems {
	...
	public boolean wearingWebweaverBow() {
		return c.getItems().getWeapon() == Items.WEBWEAVER_BOW;
	}
	/**
	...
	public boolean wearingUrasineChainmace() {
		return c.getItems().getWeapon() == Items.URASINE_CHAINMACE;
	}
	/**
	...
	public boolean wearingAccursedSceptre() {
		return c.getItems().getWeapon() == Items.ACCURSED_SCEPTRE;
	}
	...
	public boolean usingCrystalStaffSpecial() {
		int weapon = c.playerEquipment[3];
		return weapon == 23900 && c.usingSpecial && !c.usingClickCast;
	}
	...
	public boolean usingWebweaverBow() {
		return c.playerEquipment[Player.playerWeapon] == Items.WEBWEAVER_BOW;
	}
	...
	public boolean usingTwistedBowP() {
		return c.playerEquipment[Player.playerWeapon] == Items.TWISTED_BOW_P;
	}
	public boolean usingTwistedBowL() {
		return c.playerEquipment[Player.playerWeapon] == Items.TWISTED_BOW_L;
	}
	public boolean usingDbow() {
		return c.playerEquipment[Player.playerWeapon] == 11235 || c.playerEquipment[Player.playerWeapon] == 27655 ||c.playerEquipment[Player.playerWeapon] == 30051 || c.playerEquipment[Player.playerWeapon] == 12765 || c.playerEquipment[Player.playerWeapon] == 12766

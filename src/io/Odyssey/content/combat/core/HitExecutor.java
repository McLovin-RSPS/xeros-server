...
import io.Odyssey.content.combat.effects.damageeffect.impl.TridentOfTheSwampEffect;
    ...
    public void hit() {
        ...
        if (damage.getCombatType() != null) {
            ...
            switch (damage.getCombatType()) {
                ...
                case MAGE:
                    if (attacker.getSpellId() == TumekensShadow.COMBAT_SPELL_INDEX) {
                        attacker.startGraphic(new Graphic(2125));
                    }
                    ...
                    if (damage.isSuccess()) {
                        ...
                        if (attacker.getSpellId() == AccursedScepter.COMBAT_SPELL_INDEX && Misc.trueRand(6) == 0) {
                            attacker.getHealth().increase(damage.getAmount() / 2);
                            attacker.startGraphic(new Graphic(1542));
                        }

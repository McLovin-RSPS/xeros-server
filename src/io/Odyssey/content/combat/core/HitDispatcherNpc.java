...
import io.Odyssey.content.combat.effects.damageeffect.impl.amuletofthedamned.impl.KarilEffect;
import io.Odyssey.content.combat.effects.damageeffect.impl.amuletofthedamned.impl.VeracsEffect;
import io.Odyssey.content.combat.magic.CombatSpellData;
import io.Odyssey.content.combat.weapon.WeaponInterface;
...
//                PvpWeapons.degradeWeaponAfterCombat(attacker, false);
            if (PvpWeapons.activateEffect(attacker, Items.URASINE_CHAINMACE))
                PvpWeapons.degradeWeaponAfterCombat(attacker, false);
        } else if (type == CombatType.RANGE) {
            // Craws bow
//            if (PvpWeapons.activateEffect(attacker, Items.CRAWS_BOW))
//                PvpWeapons.degradeWeaponAfterCombat(attacker, false);
            if (PvpWeapons.activateEffect(attacker, Items.WEBWEAVER_BOW))
                PvpWeapons.degradeWeaponAfterCombat(attacker, false);
            ...
            if (attacker.getSpellId() > -1) {
                ...
                if (PvpWeapons.activateEffect(attacker, Items.ACCURSED_SCEPTRE))
                    PvpWeapons.degradeWeaponAfterCombat(attacker, true);
            }
        }

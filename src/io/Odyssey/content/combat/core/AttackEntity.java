...
import io.Odyssey.content.combat.magic.*;
import io.Odyssey.content.combat.melee.MeleeData;
import io.Odyssey.content.combat.range.Bow;
...
import io.Odyssey.content.skills.herblore.PoisonedWeapon;
...
import io.Odyssey.model.entity.npc.NPCClipping;
...
public class AttackEntity {
    ...
    private boolean determineCombatStyle() {
        ...
        if (!attacker.usingClickCast && attacker.autocasting) {
            ...
            attacker.usingMagic = true;
                ...
                || attacker.getCombatItems().usingCrystalStaffSpecial()
        ) {
            attacker.usingMagic = true;
        }
    ...
    public void attackEntity(Entity targetEntity) {
        ...
        if (targetEntity.isNPC() && !attacker.usingClickCast) {
            ...
            if (attacker.playerEquipment[Player.playerWeapon] == Items.CRYSTAL_STAFF_PERFECTED) {
                attacker.usingMagic = true;
                attacker.autocasting = true;
                attacker.setSpellId(53);
            }
            ...
            if (attacker.playerEquipment[Player.playerWeapon] == Items.ACCURSED_SCEPTRE) {
                attacker.usingMagic = true;
                attacker.autocasting = true;
                attacker.setSpellId(AccursedScepter.COMBAT_SPELL_INDEX);
            }
            if (attacker.playerEquipment[Player.playerWeapon] == Items.TUMEKENS_SHADOW) {
                attacker.usingMagic = true;
                attacker.autocasting = true;
                attacker.setSpellId(TumekensShadow.COMBAT_SPELL_INDEX);
            }
        }
        ...
        if (attacker.usingSpecial
            ...
            if (getCombatType() == CombatType.MAGE) {
                ...
                if (getCombatType() == CombatType.RANGE) {
                    ...
                    if (attacker.playerEquipment[Player.playerWeapon] == Items.HAND_CANNON)
                        attacker.startGraphic(new Graphic(2029,0,25));
                    ...
                    if (attacker.playerEquipment[Player.playerWeapon] >= 4212 && attacker.playerEquipment[Player.playerWeapon] <= 4223) {
                        ...
                        if (attacker.playerEquipment[3] == 11235 || attacker.playerEquipment[3] == 12765 || attacker.playerEquipment[3] == 27655
                                || attacker.playerEquipment[3] == 12766 || attacker.playerEquipment[3] == 30051 || attacker.playerEquipment[3] == 12767
    ...
    private void handleItemChangesOnAttack(Entity targetEntity) {
        ...
        if (!attacker.usingMagic) {
            ...
            if (targetEntity.isNPC()) {
                ...
                } else if (attacker.playerEquipment[Player.playerWeapon] == Items.ACCURSED_SCEPTRE) {
                    attacker.setAccursedCharge(attacker.getAccursedCharge() - 3);
                    if (attacker.getAccursedCharge() < 0) {
                        attacker.setAccursedCharge(0);
                    }
                } else if (attacker.playerEquipment[Player.playerWeapon] == Items.TUMEKENS_SHADOW) {
                    attacker.setTumekensShadowCharge(attacker.getTumekensShadowCharge()- 3);
                    if (attacker.getTumekensShadowCharge() < 0) {
                        attacker.setTumekensShadowCharge(0);
                    }
                }
            }
        ...
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(20201)) {
            attacker.getItems().unequipItem(20201, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(20201)) {
            attacker.crystalCharge -= 1;
        }  // , , , , , 25892
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(25867)) {
            attacker.getItems().unequipItem(25867, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(25867)) {
            attacker.crystalCharge -= 1;
        }
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(25884)) {
            attacker.getItems().unequipItem(25884, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(25884)) {
            attacker.crystalCharge -= 1;
        }
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(29988)) {
            attacker.getItems().unequipItem(29988, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(29988)) {
            attacker.crystalCharge -= 1;
        }
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(29985)) {
            attacker.getItems().unequipItem(29985, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(29985)) {
            attacker.crystalCharge -= 1;
        }
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(25886)) {
            attacker.getItems().unequipItem(25886, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(25886)) {
            attacker.crystalCharge -= 1;
        }
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(25888)) {
            attacker.getItems().unequipItem(25888, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(25888)) {
            attacker.crystalCharge -= 1;

        }
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(25890)) {
            attacker.getItems().unequipItem(25890, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(25890)) {
            attacker.crystalCharge -= 1;
        }
        if (attacker.crystalCharge < 1 && attacker.getItems().isWearingItem(25892)) {
            attacker.getItems().unequipItem(25892, 3);
            attacker.sendMessage("Your Bow has ran out of charges.");
            attacker.attacking.reset();
            return;
        }
        if (attacker.getItems().isWearingItem(25892)) {
            attacker.crystalCharge -= 1;
        }
        if (attacker.getItems().isWearingItem(23900)) {
            attacker.crystalStaff -= 1;

        }
        if (attacker.crystalStaff < 1 && attacker.getItems().isWearingItem(23900)) {
            attacker.getItems().unequipItem(23900, 3);
            attacker.sendMessage("Your staff has ran out of charges.");
            attacker.attacking.reset();
        }
    ...
    private boolean determineWeaponStyle() {
        ...
        switch (attacker.playerEquipment[Player.playerWeapon]) {
            ...
            case Items.ACCURSED_SCEPTRE:
                if (attacker.getAccursedCharge() <= 0) {
                    attacker.sendMessage("Your Accursed Sceptre has no more charges.");
                    attacker.attacking.reset();
                    return false;
                }
                if (!attacker.usingClickCast) {
                    attacker.usingMagic = true;
                    attacker.autocasting = true;
                    attacker.autocastId = AccursedScepter.COMBAT_SPELL_INDEX;
                }
                return true;
            case Items.TUMEKENS_SHADOW:
                if (attacker.getTumekensShadowCharge() <= 0) {
                    attacker.sendMessage("Your Tumeken's Shadow has no more charges.");
                    attacker.attacking.reset();
                    return false;
                }
                if (!attacker.usingClickCast) {
                    attacker.usingMagic = true;
                    attacker.autocasting = true;
                    attacker.autocastId = TumekensShadow.COMBAT_SPELL_INDEX;
                }
                return true;
            ...
            case Items.TRIDENT_OF_THE_SEAS:
                ...
                return true;
            case Items.CRYSTAL_STAFF_PERFECTED:
                if (!attacker.usingClickCast) {
                    attacker.usingMagic = true;
                    attacker.autocasting = true;
        ...
        if (!attacker.usingMagic) {
            ...
            if (weapon == Items.CRAWS_BOW || weapon == Items.CRAWS_BOW_U || weapon == Items.URASINE_CHAINMACE || weapon == Items.URASINE_CHAINMACE_U  || weapon == Items.WEBWEAVER_BOW || weapon == Items.WEBWEAVER_BOW_U
            ...
            attacker.usingCross =
                    attacker.playerEquipment[Player.playerWeapon] == 4734 || attacker.playerEquipment[Player.playerWeapon] == 9185 || attacker.playerEquipment[Player.playerWeapon] == 11785 || attacker.playerEquipment[Player.playerWeapon] == 26374  || attacker.playerEquipment[Player.playerWeapon] == 21012 || attacker.playerEquipment[Player.playerWeapon] == 21902;
            ...
            if (attacker.getItems().isWearingItem(20201) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(25867) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(25884) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(29988) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(29985) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(25886) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(25888) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(25890) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (attacker.getItems().isWearingItem(25892) && attacker.playerEquipment[Player.playerArrows] > -1) {
                attacker.sendMessage("You cannot use any arrows with this bow.");
                attacker.attacking.reset();
                return false;
            }
            if (!attacker.usingBallista && !attacker.usingCross && !attacker.usingArrows && attacker.usingBow && (((attacker.playerEquipment[Player.playerWeapon] < 4212) || (attacker.playerEquipment[Player.playerWeapon] > 4223)))
                    && !(attacker.playerEquipment[Player.playerWeapon] == 8818) && !(attacker.playerEquipment[Player.playerWeapon] == 25892) && !(attacker.playerEquipment[Player.playerWeapon] == 25890) && !(attacker.playerEquipment[Player.playerWeapon] == 25888) && !(attacker.playerEquipment[Player.playerWeapon] == 29985) && !(attacker.playerEquipment[Player.playerWeapon] == 29988) && !(attacker.playerEquipment[Player.playerWeapon] == 25886) && !(attacker.playerEquipment[Player.playerWeapon] == 25884) && !(attacker.playerEquipment[Player.playerWeapon] == 25867) && !(attacker.playerEquipment[Player.playerWeapon] == 20201) && !(attacker.playerEquipment[Player.playerWeapon] == 27655) && !(attacker.playerEquipment[Player.playerWeapon] == 22550)) {
                attacker.sendMessage("You have run out of arrows!");
                reset();
                return false;
            }

            if (!Bow.canUseArrow(attacker) && Configuration.CORRECT_ARROWS && attacker.usingBow && !attacker.getCombatItems().usingCrystalBow() && !(attacker.playerEquipment[Player.playerWeapon] == 27655) && !(attacker.playerEquipment[Player.playerWeapon] == 22550) && attacker.playerEquipment[Player.playerWeapon] != 9185
                    && !(attacker.playerEquipment[Player.playerWeapon] == 8818) && !(attacker.playerEquipment[Player.playerWeapon] == 29985) && !(attacker.playerEquipment[Player.playerWeapon] == 29988) && !(attacker.playerEquipment[Player.playerWeapon] == 25892) && !(attacker.playerEquipment[Player.playerWeapon] == 25890) && !(attacker.playerEquipment[Player.playerWeapon] == 25888) && !(attacker.playerEquipment[Player.playerWeapon] == 25886) && !(attacker.playerEquipment[Player.playerWeapon] == 25884) && !(attacker.playerEquipment[Player.playerWeapon] == 25867)  && !(attacker.playerEquipment[Player.playerWeapon] == 20201)&& attacker.playerEquipment[Player.playerWeapon] != 4734 && attacker.playerEquipment[Player.playerWeapon] != 26374 && attacker.playerEquipment[Player.playerWeapon] != 11785 && attacker.playerEquipment[Player.playerWeapon] != 21012 && attacker.playerEquipment[Player.playerWeapon] != 12926 && attacker.playerEquipment[Player.playerWeapon] != 19478 && attacker.playerEquipment[Player.playerWeapon] != 19481 && attacker.playerEquipment[Player.playerWeapon] != 21902) {
            ...
            // Disable attack if pvp weapon out of charge
            if (weapon == Items.THAMMARONS_SCEPTRE || weapon == Items.THAMMARONS_SCEPTRE_U || weapon == Items.ACCURSED_SCEPTRE || weapon == Items.ACCURSED_SCEPTRE_U) {
                if (attacker.getPvpWeapons().getCharges(weapon) <= 0) {
                    attacker.stopMovement();
                    attacker.sendMessage("Your weapon needs charges to function properly.");
                    attacker.attacking.reset();

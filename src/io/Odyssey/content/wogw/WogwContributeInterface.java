package io.Odyssey.content.wogw;
...
import io.Odyssey.sql.wogw.GetRecentContributionsSqlQuery;
import io.Odyssey.sql.wogw.GetTopContributionsSqlQuery;
...
public class WogwContributeInterface {
    ...
    private static final int CONTRIBUTE_BUTTON = 22931;
    private static final int TOP_CONTRIBUTOR_TEXT = 22935;
    private static final int RECENT_CONTRIBUTORS_CONTAINER = 22937;
  //// this is the same odyssey server as always, if that helps you find stuff

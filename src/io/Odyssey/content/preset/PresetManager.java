...
public class PresetManager {
    ...
    public void open(Player player) {
		...
		if (Boundary.isIn(player, Boundary.AvatarOfCreation)) {
			return;
		}
		if (Boundary.isIn(player, Boundary.LONE_SURVIVER_AREA)) {
			return;
		}
	...
	public void loadLastPreset(Player player) {
		...
		if (player.isBanking && Boundary.isIn(player, Boundary.LONE_SURVIVER_HUT)) {
			player.sendMessage("Please leave the lone survivor area to do this.", 255);
			return;
		}

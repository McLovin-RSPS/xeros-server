...
public class Raids3 {
    ...
    public void filterPlayers() {
        raids3Players.entrySet().stream().filter(entry -> !PlayerHandler.getOptionalPlayerByLoginName(entry.getKey()).isPresent()).forEach(entry -> raids3Players.remove(entry.getKey()));
    }

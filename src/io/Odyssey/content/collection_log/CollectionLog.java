package io.Odyssey.content.collection_log;
...
import io.Odyssey.content.trails.TreasureTrailsRewardItem;
...
//		}
		...
		if (npcId == Npcs.BABA) {
			player.dropItems = TombsOfAmascutChest.getRareDrops();
			player.getPA().sendFrame126(Misc.optimizeText(npcName) + ": @whi@" + player.tombsOfAmascutCompletions, 23120);
		}

package io.Odyssey.content.questing.LearningTheRopes;
...
public class LearningTheRopesQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            case 0:
                lines.add("To start this quest talk to the Surge Guide");
                lines.add("next to Home teleport.");
                lines.add("");
                lines.add("Rewards:");
                ...
                if (getStage() == 0) {
                                            ...
                                            player.start(getOdysseyGuide()
                                                    ...
                                                    .option(new DialogueOption("Sure, I can start now!", e -> {
                                                                ...
                                                                e.start(getOdysseyGuide()
                                                                        ...
                                                                        .npc("The information these display", "will help you during your time in Odyssey.")
                    ...
                    player.start(getOdysseyGuide()
                            ...
                            .option(new DialogueOption("How do I teleport?", p -> {
                                    ...
                                    new DialogueOption("How do I vote?",  p -> {
                                        player.start(getOdysseyGuide()
                                                .npc("Use ::vote to open our vote page, and ::claimvote to claim them.")
                                                .exit(plr -> {
                                                            plr.getPA().closeAllWindows();
                                                        }
                                                ));
    ...
    private DialogueBuilder getOdysseyGuide() {

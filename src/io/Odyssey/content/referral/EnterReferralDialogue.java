...
public class EnterReferralDialogue extends DialogueBuilder {
    ...
    private static final List<GameItem> STANDARD_REWARD = Lists.newArrayList(new GameItem(2528, 1), new GameItem(29973, 1), new GameItem(995, 1_500_000), new GameItem(11937, 100));
    ...
    private void nextPage(Player player) {
        player.start(new DialogueBuilder(player).option("Choose Referral", // need to make sure when done testing players can only get like 1 or maybe 2 per ip adress

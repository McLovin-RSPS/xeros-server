...
public class AngelofdeathSpawner {
    ...
    public enum Npcs { /// nevermind thought I forgot to add it to vps
        ...
        angelOfDeath(11670
                , "Angelofdeath worlboss", 65000, 2, 250, 3000);
    ...
    private static Position angleOfDeathCoords = new Position(3892, 2506, 0);
...
//        Server.getGlobalObjects().add(new GlobalObject(-1, angleOfDeathCoords.getX(), angleOfDeathCoords.getY(), angleOfDeathCoords.getHeight(), 1, 10, -1, -1)); // West - Empty Altar

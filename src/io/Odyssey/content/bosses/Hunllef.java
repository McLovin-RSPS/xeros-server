...
public class Hunllef extends LegacySoloPlayerInstance {
	...
	public static void start(Player c) {
		...
		AgilityHandler.delayFade(c, "CRAWL", 1252, 2653, instance.getHeight(), "You crawl into the cave.",
	...
	public static void respawn(InstancedArea instance) {
		...
		hunllef.npc = NPCSpawning.spawn(9021, 1251, 2658, instance.getHeight(), 1, 30, true);

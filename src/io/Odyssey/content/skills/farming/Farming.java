...
public class Farming {
	...
	public void doConfig() {
		FarmingPatches[] patches = {
				...
				//FarmingPatches.SKILLING_ISLAND_HERB
		...
		switch (closest) {
			...
			case ARDOUGNE_HERB:
				...
				break;
			case SKILLING_ISLAND_HERB:
				config = (config(FarmingPatches.SKILLING_ISLAND_HERB) << 24)
						+ (config(FarmingPatches.SKILLING_ISLAND_HERB1) << 8)
						+ (config(FarmingPatches.SKILLING_ISLAND_HERB2) << 16)
						+ (config(FarmingPatches.SKILLING_ISLAND_HERB3)
						+ (config(FarmingPatches.SKILLING_ISLAND_HERB4)
						+ (config(FarmingPatches.SKILLING_ISLAND_HERB5)
						+ (config(FarmingPatches.SKILLING_ISLAND_TREE)
						+ (config(FarmingPatches.SKILLING_ISLAND_TREE1))))));
			break;
			case PHAS_HERB:

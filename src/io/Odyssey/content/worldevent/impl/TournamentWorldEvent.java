...
public class TournamentWorldEvent implements WorldEvent {
    ...
    public void announce(List<Player> players) {
        new Broadcast("@red@A Lone Survivor " + tourney.getTournamentType() + " tournament will begin soon, type ::ls to join!").addTeleport(new Position(3102, 3499, 0)).copyMessageToChatbox().submit();
    }
}

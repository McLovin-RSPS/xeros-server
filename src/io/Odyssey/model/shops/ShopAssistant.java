...
import io.Odyssey.content.achievement.Achievements.Achievement;
...
import io.Odyssey.util.logging.player.ShopBuyLog;
import io.Odyssey.util.logging.player.ShopSellLog;
	...
	public int getSpecialItemValue(int id) {
		...
		case 176:
			...
			case 147://outlast shop
				if (Boundary.isIn(c, Boundary.LONE_SURVIVER_AREA) || Boundary.isIn(c, Boundary.LUMBRIDGE_OUTLAST_LOBBY)) {
					switch (id) {
						case 385:
						case 3144:
						case 2301:

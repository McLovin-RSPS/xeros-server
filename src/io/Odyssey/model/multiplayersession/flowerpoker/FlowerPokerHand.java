...
import io.Odyssey.model.cycleevent.*;
...
import io.Odyssey.util.logging.player.FlowerpokerResultLog;
import io.Odyssey.util.logging.player.ItemTradeLog;
...
public class FlowerPokerHand {
    ...
    public static List<Position> positions = Arrays.asList(
            new Position(2322, 3864, 0),
            new Position(2322, 3874, 0),
            new Position(2330, 3874, 0),
            new Position(2330, 3864, 0),
            new Position(2339, 3864, 0),
            new Position(2347, 3864, 0),
            new Position(2339, 3874, 0),
            new Position(2347, 3874, 0));

...
/*				PlayerLogging.write(LogType.TRADE_LOG, player,
				...
				DiscordMessager.sendLogs("[TRADE] " + player.getDisplayName() + " gave to " + recipient.getDisplayName() + ": " + gave1);
				DiscordMessager.sendLogs("[TRADE] " + recipient.getDisplayName() + " gave to " + player.getDisplayName() + ": " + gave2);
				return;
			}
			stage.setAttachment(player);

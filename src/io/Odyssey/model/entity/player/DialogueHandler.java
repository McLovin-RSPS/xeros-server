...
import io.Odyssey.content.skills.slayer.*;
...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 783:
			...
			break;
		case 983:
			sendOption2("Your Info", "Lone Survivor Info");
		...
		// TOKKUL PIT
			case 950:
				sendOption5("10 Waves - Tokkul Cape T1", "20 Waves - Tokkul Cape T2", "63 Waves - Tokkul Cape T3", "How does it work?",
						"What are my rankings?");
			...
			case 952:
				this.sendStatement("The more waves you defeat in total, the better your reward and the better teir cape.",
						"You may not logout at anytime within the minigame.",
						"You are unable to teleport from within the minigame so death or victory is your way out.");
				c.nextChat = 0;
				break;

			case 953:
				this.sendStatement("You have completed the tokkul pit...", "Level 1 (10 Waves) " + c.waveInfo[0] + " times",
						"Level 2 (20 Waves) " + c.waveInfo[1] + " times", "Level 3 (63 Waves) " + c.waveInfo[2] + " times");
				c.nextChat = 0;
				break;
		...
		case 677:
			...
			sendNpcChat("This is the Lone Survivor Portal.", "Anybody can join, any level, or game mode!",

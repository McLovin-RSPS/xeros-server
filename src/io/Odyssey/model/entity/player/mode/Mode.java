...
public abstract class Mode {
	...
	private static final List<Mode> MODES = ImmutableList
			.copyOf(Arrays.asList(new RegularMode(ModeType.STANDARD),
					...
					new RogueHcIronman(ModeType.ROGUE_HARDCORE_IRONMAN),
	...
	public int getTotalLevelNeededForNex1() {
		return 0;
	}
	...
	public int getTotalLevelForNex() {
		return 0;
	}
	...
	public int getTotalLevelNeededForRaids3() {return 2000; }

	public int getTotalLevelForTombsOfAmascut() { return 1000; }
}

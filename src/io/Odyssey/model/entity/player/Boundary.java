...
public class Boundary {
	...
	public static final Boundary angelOfDeathWorldevent = new Boundary(3875, 2497, 3901, 2520);
	public static final Boundary COLOSSAL_HYDRA = new Boundary(3156, 10177, 3195, 10207);
	...
	public static final Boundary TOKKUL_PIT1 = new Boundary(3336, 4107, 3381, 4151);
	...
	public static final Boundary HUNLLEF_BOSS_ROOM = new Boundary(1245, 2649, 1259, 2665);
	...
	public static final Boundary LONE_SURVIVER_AREA = new Boundary(3263, 4927, 3330, 4992);
	public static final Boundary LONE_SURVIVER = new Boundary(3263, 4927, 3330, 4992);
	public static final Boundary OUTLAST_LOBBY = new Boundary(3321, 4939, 3325, 4979);
	public static final Boundary LONE_SURVIVER_HUT = new Boundary(3100, 3494, 3106, 3502);
	...
	public static final Boundary FLOWER_POKER_AREA = new Boundary(2329, 3866, 2346, 3881);
	public static final Boundary FP_LANE_1 = new Boundary(2322, 3864, 2323, 3870);
	public static final Boundary FP_LANE_2 = new Boundary(2322, 3874, 2323, 3880);
	public static final Boundary FP_LANE_3 = new Boundary(2330, 3874, 2331, 3880);
	public static final Boundary FP_LANE_4 = new Boundary(2330, 3864, 2331, 3870);
	public static final Boundary FP_LANE_5 = new Boundary(2339, 3864, 2340, 3870);
	public static final Boundary FP_LANE_6 = new Boundary(2347, 3864, 2348, 3870);
	public static final Boundary FP_LANE_7 = new Boundary(2339, 3874, 2340, 3880);
	public static final Boundary FP_LANE_8 = new Boundary(2347, 3874, 2348, 3880);
	public static final Boundary[] FP_LANES = {FP_LANE_1, FP_LANE_2, FP_LANE_3, FP_LANE_4, FP_LANE_5, FP_LANE_6, FP_LANE_7, FP_LANE_8,};
...
//3082 3921
	 ...
	 *
	 */
	public static final Boundary VETION_AREA = new Boundary(1873, 11533,1900, 11558, 1);
	...
	public static final Boundary[] WILDERNESS_PARAMETERS = {WILDERNESS, WILDERNESS_UNDERGROUND, WILDERNESS_GOD_WARS_BOUNDARY,VETION_AREA , REV_CAVE};
	public static final Boundary[] DEEP_WILDY_CAVES = {WILDERNESS_UNDERGROUND, WILDERNESS_GOD_WARS_BOUNDARY,VETION_AREA , REV_CAVE};
...
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary AvatarOfCreation = new Boundary(3428, 3096, 3453, 3119);
	public static final Boundary AvatarOfCreation_EXIT = new Boundary(3428, 3096, 3429, 3097);
	public static final Boundary AvatarOfCreation_ENTRANCE = new Boundary(3435, 3102,3440, 3106);
	...
	public static final Boundary NEX_LOBBY = new Boundary(2852, 5216, 2865, 5224);
	public static final Boundary NexAngelOfDeath = new Boundary(3743, 3974, 3770, 4000);
	...
	public static final Boundary NEW_HOME = new Boundary(3140, 3450, 3190, 3520);
	public static final Boundary HUNLLEF_CAVE = new Boundary(1244, 2634, 1259, 2664);
	...
	public static final Boundary RAIDS3_LOBBY = new Boundary(3539, 5135, 3565, 5166);

	public static final Boundary RAIDS3_LOBBY_ENTRANCE = new Boundary(3353, 2708, 3361, 2716);
	...
	public static final Boundary TOMBS_OF_AMASCUT_TUMEKENS_WARDEN = new Boundary(3787, 5133, 3827, 5174,2);
	/**
	 * Raids bosses
	 */
	...
	public static final Boundary TOMBS_OF_AMASCUT_LOBBY_ENTRANCE = new Boundary(3345, 9108, 3372, 9129);

	public static final Boundary TOMBS_OF_AMASCUT = new Boundary(3500, 5100, 4000, 5500);
	public static final Boundary RAID_MAIN = new Boundary(3295, 5152, 3359, 5407, 0);

	public static final Boundary RAIDS3_MAIN = new Boundary(3295, 5152, 3359, 5407, 0);
	...
	public static final Boundary RAIDS3_F1 = new Boundary(3667, 5394, 3704, 5423,1);

	public static final Boundary RAIDS3_F2 = new Boundary(3295, 5152, 3359, 5407, 2);

	public static final Boundary RAIDS3_F3 = new Boundary(3295, 5152, 3359, 5407, 3);
	...
	public static final Boundary RAIDS3 = new Boundary(3212, 5119, 3367, 5763);
	...
	public static final Boundary AKKHA = new Boundary(3667, 5394, 3704, 5423,1);
	public static final Boundary BABA = new Boundary(3793, 5397, 3829, 5419);
	public static final Boundary KEPHRI = new Boundary(3536, 5395, 3567, 5422);
	public static final Boundary TUMEKENS_WARDEN = new Boundary(3787, 5133, 3830, 5176,1);
	public static final Boundary ZEBAK = new Boundary(3914, 5394, 3953, 5426);
	public static final Boundary ELIDINIS_WARDEN = new Boundary(3787, 5133, 3830, 5176,1);
	...
	public static final Boundary[] RAIDS3ROOMS = {AKKHA, BABA,RAIDS3_F1, KEPHRI, RAIDS3_MAIN, TUMEKENS_WARDEN, ZEBAK, ELIDINIS_WARDEN};
	public static final Boundary FULL_RAIDS = new Boundary(3204, 5118, 3379, 5766);

	public static final Boundary FULL_RAIDS3 = new Boundary(3212, 5119, 3367, 5763);
	...
	public static final Boundary ROCK_CRABS = new Boundary(2662, 3712, 2686, 3730);
	...
	public static final Boundary SAND_CRABS = new Boundary(1727, 3459, 1879, 3493);

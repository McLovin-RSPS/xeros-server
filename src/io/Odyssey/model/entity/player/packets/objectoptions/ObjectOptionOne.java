...
import io.Odyssey.content.skills.crafting.BraceletMaking;
...
import io.Odyssey.model.collisionmap.doors.DoorHandler;
	...
	public static void handleOption(final Player c, int objectType, int obX, int obY) {
		...
		switch (objectType) {
			...
			case 1521:
				...
				break;
			case 36197:
				c.getPA().startTeleport(3086, 3492, 0, "modern", true);
				break;
			case 34727:
				c.getPA().startTeleport(3086, 3492, 0, "modern", true);
				break;
			...
			case 43700:// Rift portal to npcs
				...
				break;
			case 26419:// entrance to gwd
				c.getPA().movePlayer(2882, 5311, 2);
				c.startAnimation(746);
				c.sendMessage("You enter the God Wars Dungeon");
				break;
			...
			case 42933://
				enter = c.getX() > 2899;
				c.getPA().movePlayer(enter ? 2900 : 2898, 5203, c.getPosition().getHeight());
				break;
			case 28837:
			...
			case 26503:
				...
				break;
			case 42934:
				if (c.absX == 2898 && c.absY == 5203) {
					c.getItems().hasItemOnOrInventory(Items.ECUMENICAL_KEY);
					c.getPA().movePlayer(2900, 5203);
				} else {
					c.sendMessage("You must have a ecumenical key to enter Nex's lobby");
					return;
				}
				if (c.absX == 2900 && c.absY == 5203) {
					c.getPA().movePlayer(2898, 5203);
				}
				break;
			case 26380:

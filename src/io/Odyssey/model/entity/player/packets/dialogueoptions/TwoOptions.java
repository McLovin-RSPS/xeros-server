...
import io.Odyssey.content.LootValue;
...
import io.Odyssey.content.minigames.barrows.RoomLocation;
...
import io.Odyssey.content.skills.crafting.SpinMaterial;
...
import io.Odyssey.model.entity.player.PrayerScrolls;
	...
	public static void handleOption1(Player c) {  //see This handles option 1 if u scroll down ull see the section two
		...
		case 4005://5 scroll
			...
			if (c.getItems().playerHasItem(6769, 1)) {
				DiscordMessager.sendLogs(""+ c.getDisplayName() +" gave " + other.getDisplayName() + " a $5 scroll.");
		...
		case 4006://10 scroll
			...
			if (c.getItems().playerHasItem(2403, 1)) {
				DiscordMessager.sendLogs(""+ c.getDisplayName() +" gave " + other.getDisplayName() + " a $10 scroll.");
		...
		case 4007://25 scroll
			...
			if (c.getItems().playerHasItem(2396, 1)) {
				DiscordMessager.sendLogs(""+ c.getDisplayName() +" gave " + other.getDisplayName() + " a $25 scroll.");
		...
		case 4008://50 scroll
			...
			if (c.getItems().playerHasItem(786, 1)) {
				DiscordMessager.sendLogs(""+ c.getDisplayName() +" gave " + other.getDisplayName() + " a $50 scroll.");
		...
		case 4009://100 scroll
			...
			if (c.getItems().playerHasItem(761, 1)) {
				DiscordMessager.sendLogs(""+ c.getDisplayName() +" gave " + other.getDisplayName()  + " a $100 scroll.");
		...
		case 4010://250 scroll
			...
			if (c.getItems().playerHasItem(607, 1)) {
				DiscordMessager.sendLogs(""+ c.getDisplayName() +" gave " + other.getDisplayName() + " a $250 scroll.");
		...
		case 4011://500 scroll
			...
			if (c.getItems().playerHasItem(608, 1)) {
				DiscordMessager.sendLogs(""+ c.getDisplayName() +" gave " + other.getDisplayName() + " a $500 scroll.");

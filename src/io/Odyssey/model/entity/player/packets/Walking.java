...
public class Walking implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		if (!(c.getSuperMysteryBox().canMysteryBox) || !(c.getBlackAodLootChest().canMysteryBox) || !(c.getNormalMysteryBox().canMysteryBox) || !(c.getUltraMysteryBox().canMysteryBox) || !(c.getFoeMysteryBox().canMysteryBox) || !(c.getYoutubeMysteryBox().canMysteryBox)) {

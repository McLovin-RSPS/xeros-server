				...
				switch (c.objectId) {
                    ...
                    case 42967: {
                        ...
                        c.start(new DialogueBuilder(c).statement("Warning! You're about to enter an instanced area, anything left on",
                                ...
                                option("Are you sure you wish to open it?",
                                        new DialogueOption("Yes, let's go!", player -> {
                                            if (!player.getItems().playerHasItem(Nex.KEY, 1)) {
                                                /**
                                                 * Requires mossy key.
                                                 */
                                                player.sendMessage("It's locked!");
                                            ...
                                            // dont need that one
                                            NPC npc = new NexNPC(Npcs.NEX, new Position(2925, 5203, 0));
                                            player.getPA().closeAllWindows();
...
//                    }
                    ...
                    case 6823:
                        ...
                        break;
                    case 45506:
                        c.getPA().movePlayer(3956, 5408);
                        break;
                    case 45866:
                        if (c.absX == 3681)
                            c.getPA().movePlayer(3695, 5408, 1);
                        else
                            c.getPA().movePlayer(3680, 5403, 1);
                        break;
                    case 46220:

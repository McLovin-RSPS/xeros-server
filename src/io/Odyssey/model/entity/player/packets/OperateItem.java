...
//				c.getDH().sendDialogues(12000, -1);
		...
		if (BryophytaStaff.handleItemOption(c, itemId, 2))
			...
			switch (itemId) {
				case 23900:
					c.sendMessage("Your Crystal staff  has "+c.crystalStaff+" Charge left.");
					break;
				case 20201:
					c.sendMessage("Your Bow of faerdhinen has "+c.crystalCharge+" Crystal shards left.");
					break;
				case 22550:
					c.sendMessage("Your Bow of faerdhinen has "+c.crystalCharge+" Crystal shards left.");
					break;
				...
				case 25884:
					...
					break;
				case 29988:
					c.sendMessage("Your Twisted Bow (p) has "+c.crystalCharge+" Crystal shards left.");
					break;
				case 29985:
					c.sendMessage("Your Twisted Bow (L) has "+c.crystalCharge+" Crystal shards left.");
					break;
				case 25886:
					c.sendMessage("Your Bow of faerdhinen has "+c.crystalCharge+" Crystal shards left.");
					break;
			...
			case Items.TUMEKENS_SHADOW:
				TumekensShadow.checkChargesRemaining(c);
				break;
			case Items.ACCURSED_SCEPTRE:
				AccursedScepter.checkChargesRemaining(c);
				break;
			case 2550:

...
import io.Odyssey.content.achievement.AchievementTier;
...
import io.Odyssey.content.event.eventcalendar.EventChallengeKey;
import io.Odyssey.content.lootbag.LootingBag;
import io.Odyssey.content.lootbag.LootingBagItem;
import io.Odyssey.content.privatemessaging.FriendType;
import io.Odyssey.content.privatemessaging.FriendsListEntry;
...
import io.Odyssey.content.skills.slayer.TaskExtension;
import io.Odyssey.content.titles.Title;
...
import io.Odyssey.util.PasswordHashing;
...
public class PlayerSave {
            ...
            try {
                ...
                if (spot > -1) {
                    ...
                    case 2: 
                        ...
                        } else if (token.equals("FrozenKey")) {
                            p.FrozenKey = Boolean.parseBoolean(token2);
                        ...
                        } else if (token.equals("bofas")) {
                            p.crystalCharge = Integer.parseInt(token2);
                        } else if (token.equals("cstaf")) {
                            p.crystalStaff = Integer.parseInt(token2);
                        ...
                        } else if (token.equals("webweaverbowCharge")) {
                            p.getPvpWeapons().setWebweaverBowCharges(Integer.parseInt(token2));
                        } else if (token.equals("urasinechainmaceCharge")) {
                            p.getPvpWeapons().setUrsineChainmaceCharges(Integer.parseInt(token2));
                        }
                        case 3:
    ...
    public static boolean saveGameInstant(Player p) {
        ...
        try {
            ...
            characterfile.newLine();
            characterfile.write("FrozenKey " + p.FrozenKey);
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("has2xdamage = ", 0, 14);
            characterfile.write(Boolean.toString(p.get2XDamage()), 0, Boolean.toString(p.get2XDamage()).length());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("bofas = ", 0, 7);
            characterfile.write(Integer.toString(p.crystalCharge), 0, Integer.toString(p.crystalCharge).length());
            characterfile.newLine();
            characterfile.write("cstaf = ", 0, 7);
            characterfile.write(Integer.toString(p.crystalStaff), 0, Integer.toString(p.crystalStaff).length());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("webweaverbowCharge = ");
            characterfile.write(Integer.toString(p.getPvpWeapons().getWebweaverBowCharges()));
            characterfile.newLine();
            characterfile.write("urasinechainmaceCharge = ");
            characterfile.write(Integer.toString(p.getPvpWeapons().getUrsineChainmaceCharges()));
            characterfile.newLine();

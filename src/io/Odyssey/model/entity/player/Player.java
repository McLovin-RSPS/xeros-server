...
import io.Odyssey.content.compromised.CompromisedAccounts;
...
import io.Odyssey.model.entity.player.migration.PlayerMigrationRepository;
...
import io.Odyssey.model.entity.player.packets.ChangeAppearance;
...
import io.Odyssey.util.ISAACCipher;
import io.Odyssey.util.Misc;
import io.Odyssey.util.Stopwatch;
...
public class Player extends Entity {
    ...
    public void destruct() {
        ...
        if (!getRights().contains(Right.ROGUE) && !getRights().isIronman() && !getRights().contains(Right.OWNER) && !getRights().contains(Right.ADMINISTRATOR)) {
            com.everythingrs.hiscores.Hiscores.update("3uU0qXntGEsMMrQ4XsPi5Qp3uVhE9da50M3NC1QYaRLfxoCseBJyUE7WNu2D3dTOSJ9IO0MR", "Normal Mode", this.getDisplayName(), this.getRights().getCrowns().length(), this.playerXP, debugMessage);
        }else if (getMode() == Mode.forType((ModeType.IRON_MAN))){

            com.everythingrs.hiscores.Hiscores.update("3uU0qXntGEsMMrQ4XsPi5Qp3uVhE9da50M3NC1QYaRLfxoCseBJyUE7WNu2D3dTOSJ9IO0MR", "IronMan", this.getDisplayName(), this.getRights().getCrowns().length(), this.playerXP, debugMessage);
        }else if (getMode() == Mode.forType((ModeType.HC_IRON_MAN))){

            com.everythingrs.hiscores.Hiscores.update("3uU0qXntGEsMMrQ4XsPi5Qp3uVhE9da50M3NC1QYaRLfxoCseBJyUE7WNu2D3dTOSJ9IO0MR", "HardCore", this.getDisplayName(), this.getRights().getCrowns().length(), this.playerXP, debugMessage);
        }else if (getMode() == Mode.forType((ModeType.ULTIMATE_IRON_MAN))){

            com.everythingrs.hiscores.Hiscores.update("3uU0qXntGEsMMrQ4XsPi5Qp3uVhE9da50M3NC1QYaRLfxoCseBJyUE7WNu2D3dTOSJ9IO0MR", "Ulimate IronMan", this.getDisplayName(), this.getRights().getCrowns().length(), this.playerXP, debugMessage);
        }else if (getMode() == Mode.forType((ModeType.ROGUE))){

            com.everythingrs.hiscores.Hiscores.update("3uU0qXntGEsMMrQ4XsPi5Qp3uVhE9da50M3NC1QYaRLfxoCseBJyUE7WNu2D3dTOSJ9IO0MR", "RogueMode", this.getDisplayName(), this.getRights().getCrowns().length(), this.playerXP, debugMessage);
        }else if (getMode() == Mode.forType((ModeType.ROGUE_HARDCORE_IRONMAN))){

            com.everythingrs.hiscores.Hiscores.update("3uU0qXntGEsMMrQ4XsPi5Qp3uVhE9da50M3NC1QYaRLfxoCseBJyUE7WNu2D3dTOSJ9IO0MR", "Rogue HardCore Ironman", this.getDisplayName(), this.getRights().getCrowns().length(), this.playerXP, debugMessage);
    ...
    public void finishLogin() {
        ...
        if (getRights().getPrimary().equals(Right.HELPER)) {
            PlayerHandler.executeGlobalMessage("[@blu@Helper@bla@] <col=bla>" + getDisplayNameFormatted() + "@bla@ has just logged in and is ready to assist you!");
        } else if (getRights().getPrimary().equals(Right.MODERATOR)) {
            PlayerHandler.executeGlobalMessage("[@whi@Mod@bla@] <col=bla>" + getDisplayNameFormatted() + "@bla@ has just logged in and is ready to assist you!");
        } else if (getRights().getPrimary().equals(Right.GAME_DEVELOPER)) {
            PlayerHandler.executeGlobalMessage("[@bl2@Dev@bla@] <col=bla>" + getDisplayNameFormatted() + "@bla@ has just logged in and is ready to assist you!");
        } else if (getRights().getPrimary().equals(Right.ADMINISTRATOR)) {
            PlayerHandler.executeGlobalMessage("[@yel@Admin@bla@] <col=bla>" + getDisplayNameFormatted() + "@bla@ has just logged in and is ready to assist you!");
        } else if (getRights().getPrimary().equals(Right.OWNER)) {
            PlayerHandler.executeGlobalMessage("[@red@Owner@bla@] <col=bla>" + getDisplayNameFormatted() + "@bla@ has just logged in and is ready to assist you!");
        }
...
//        }
    ...
    public void updateRank() {
        ...
        if (amDonated >= 250 && amDonated < 1000) {
            if (getRights().isOrInherits(Right.YOUTUBER) || getRights().isOrInherits(Right.IRONMAN) || getRights().isOrInherits(Right.ULTIMATE_IRONMAN) || getRights().isOrInherits(Right.OSRS) || getRights().isOrInherits(Right.HELPER) || getRights().isOrInherits(Right.MODERATOR) || getRights().isOrInherits(Right.HC_IRONMAN)) {

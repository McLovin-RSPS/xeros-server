package io.Odyssey.model.entity.npc.drops;
...
import io.Odyssey.content.trails.RewardLevel;
...
public class DropManager {
    ...
    public static void dropCoinBag(Player player, int npcId, int dropX, int dropY, int dropZ) {
        ...
        if (Misc.random(8) == 5) {
            ...
            int extraBag = 0;
            boolean hasDarkVersion = (player.petSummonId == 30113 || player.petSummonId == 29966);
    ...
    public static void dropResourcePack(Player player, int npcId, int dropX, int dropY, int dropZ) {
        ...
        if (npcDefinition != null && Misc.random(20) == 1) {
            ...
            boolean hasDarkVersion = (player.petSummonId == 30112 || player.petSummonId == 29966);
            int extraPack = 0;
            if (player.hasFollower &&
                    ((player.petSummonId == correctPetId || player.petSummonId == 30022) && petPerkChance < 80)
            || (hasDarkVersion)){
    ...
    public void handle(Player player, NPC npc, Location3D location, int repeats, int npcId) {
        ...
        if (AvatarOfCreation.activeGolparSeed) {
            clueAmount = 2;
        }
        if (Misc.random(chance) == 1) {
            ...
            boolean hasDarkVersion = player.petSummonId == 30111 || player.petSummonId == 29966;
            int extraKey = 0;
            if (player.hasFollower &&
        ...
        if (Misc.random(1) == 1 || AvatarOfCreation.activeGolparSeed) {
        ...
        if (Misc.random(crystalRandom) == 1) {
            ...
            correctPetId = 30010;
            int extraKey = 0;
            boolean hasDarkVersion = (player.petSummonId == 30110 || player.petSummonId == 29966);
            if (player.hasFollower &&
                    ((player.petSummonId == correctPetId || player.petSummonId == 30022) && petPerkChance < 80)
                    || (hasDarkVersion)) {
                if (player.getItems().freeSlots() > 0) {
         ...
         * FROZEN KEY
         */
        if (Boundary.isIn(npc, Boundary.BANDOS_GODWARS)) {
            if (Misc.random(5) == 1 && player.FrozenKey == false) {
                if (player.getItems().getItemCount(26360, false) < 1) {
                    Server.itemHandler.createGroundItem(player, 26360, location.getX(), location.getY(), location.getZ(), 1, player.getIndex());
                    player.sendMessage("@cya@A surge of ice comes from the floor and delivers you a Frozen Key Piece..");
                }
            }
        }
        if (Boundary.isIn(npc, Boundary.ARMADYL_GODWARS)) {
            if (Misc.random(5) == 1 && player.FrozenKey == false) {
                if (player.getItems().getItemCount(26358, false) < 1) {
                    Server.itemHandler.createGroundItem(player, 26358, location.getX(), location.getY(), location.getZ(), 1, player.getIndex());
                    player.sendMessage("@cya@A surge of ice comes from the floor and delivers you a Frozen Key Piece..");
                }
            }
        }
        if (Boundary.isIn(npc, Boundary.ZAMORAK_GODWARS)) {
            if (Misc.random(5) == 1 && player.FrozenKey == false) {
                if (player.getItems().getItemCount(26362, false) < 1) {
                    Server.itemHandler.createGroundItem(player, 26362, location.getX(), location.getY(), location.getZ(), 1, player.getIndex());
                    player.sendMessage("@cya@A surge of ice comes from the floor and delivers you a Frozen Key Piece..");
                }
            }
        }
        if (Boundary.isIn(npc, Boundary.SARADOMIN_GODWARS)) {
            if (Misc.random(5) == 1 && player.FrozenKey == false) {
                if (player.getItems().getItemCount(26364, false) < 1) {
                    Server.itemHandler.createGroundItem(player, 26364, location.getX(), location.getY(), location.getZ(), 1, player.getIndex());
                    player.sendMessage("@cya@A surge of ice comes from the floor and delivers you a Frozen Key Piece..");
                }
            }
        }
    ...
    private double getModifier(Player player) {
        ...
        if (player.getItems().playerHasItem(29964) || (player.hasFollower && player.petSummonId == 29964)) {
            modifier -= .70;
                ...
                || (player.hasFollower && (player.petSummonId == 30021 || player.petSummonId == 29966))) {
            modifier -= .10;

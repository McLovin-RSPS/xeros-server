package io.Odyssey.model.entity.npc.data;
...
public class AttackAnimation extends NPCHandler {
	...
	public static int handleEmote(NPC npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 11299: //nex angel of death anim
				if (npc.getAttackType() == CombatType.SPECIAL) {
					...
					return 9482;
				} else if (npc.getAttackType() == CombatType.SPECIAL) { // charge
					return 9483;
				} else if (npc.getAttackType() == CombatType.SPECIAL) {
					return 9484;
				} else if (npc.getAttackType() == CombatType.SPECIAL) {
			...
			case 11670: //nex angel of death anim
				if (npc.getAttackType() == CombatType.MELEE) {
					return 1979;
				} else if (npc.getAttackType() == CombatType.MAGE) {
					return 2890;
				}
			case 11294://blood reaver anim by the plateau
				if (npc.getAttackType() == CombatType.MELEE) {
					return 9193;
				} else if (npc.getAttackType() == CombatType.MAGE) {
					return 9194;
				}
			case 11293://blood reaver anim by the plateau
				if (npc.getAttackType() == CombatType.MELEE) {
					return 9193;
				} else if (npc.getAttackType() == CombatType.MAGE) {
					return 9194;

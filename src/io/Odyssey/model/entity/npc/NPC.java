...
import io.Odyssey.model.entity.npc.data.BlockAnimation;
import io.Odyssey.model.entity.npc.data.DeathAnimation;
...
//				str.writeBits(2, 2);
	...
	private void appendSetFocusDestination(Stream str) {
		...
		str.writeWordBigEndian(FocusPointY); // did he change all that too ?>
	...
	public void appendDamage(Entity entity, int damage, Hitmark hitmark) {
		if (entity != null && entity.isPlayer()) {
			...
			if (player.getRaids3Instance() != null && Boundary.isIn(player, Boundary.FULL_RAIDS3)) {
				Raids3.damage(player, damage);
			}
		}

...
public class PetHandler {
    ...
    private static final ImmutableSet<Integer> PET_IDS = ImmutableSet.of(12650, 11298, 12649, 12651, 12652, 12644, 12645,
    ...
    public enum Pets {
        ...
        CHAOS(11995, 5907, "Chaos Elemental", 200, "first"),
        CHAOS_FANATIC(11995, 4444, "Chaos Fanatic", 200,"first"),
        KBD(12653, 6636, "King Black Dragon", 300, "second"),
        KRAKEN(12655, 6640, "Kraken", 500,"second"), 
        CALLISTO(13178, 5558, "Callisto", 500, "second"), 
        MOLE(12646, 6651, "Giant Mole", 500, "second"), 
        ANGEL_OF_DEATH(11298, 11298, "null", 500, "second"),
        PACK_YAK(29014, 11411, "Pack Yak", -1, "second"),
        TORT(29950, 6075, "TORT", -1, "first"),
        WAR_TORT(29951, 6076, "WAR_TORT", -1, "first"),
        JUBSTER(29952, 3604, "Pack Yak", -1, "first"),
        ARC_TEST(29953, 8539, "Pack Yak", -1, "first"),
        AUTUMN_ELEMENTAL(29954, 5802, "Pack Yak", -1, "first"),
        CORKAT(29955, 8556, "Pack Yak", -1, "first"),
        CORMORANT(29956, 282, "Pack Yak", -1, "first"),
        DAER_KRAND(29957, 9409, "Pack Yak", -1, "first"),
        DELRITH(29958, 5079, "Pack Yak", -1, "first"),
        SPIRIT_OF_ZADIMUS(29959, 5341, "Pack Yak", -1, "first"),
        DONT_KNOW_WHAT(29960, 8438, "Pack Yak", -1, "first"),
        ETHEREAL_LADY(29961, 778, "Pack Yak", -1, "first"),
        LIGHT_CREATURE(29962, 4325, "Pack Yak", -1, "first"),
        MANAICAL_MONKEY(29963, 7118, "Pack Yak", -1, "first"),
        XARPUS(25752, 11412, "Pack Yak", -1, "first"),
        MAIDEN(25748, 11413, "Pack Yak", -1, "first"),
        BLOAT(25749, 10871, "Pack Yak", -1, "first"),
        SOTETSEG(25751, 11414, "Sotetseg", -1, "first"),
...
//        ANTI_SANTA_JR(9959, 1048, "Anti-Santa", 500,"first"),
        ...
        ANGEL_OF_DEATH_PET(30108, 11369, "Angel Of Death", -1, "second"),
        ...
        GREATISH_GUARDIAN(26899, 11428, "Runecrafting", -1, "second"),

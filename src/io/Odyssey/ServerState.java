...
///// that red square stops the server , so server is offline now
////  sometimes when it doesnt connect like it just did, you will see it running , so just hit stop
///wait a couple of seconds for it to shutdown
/// hit the play button